...
def request_scheduler(
    ...
    cached_image_paths, shared_new_images, lock,  model, processor,worker_status, scheduler_status, num_gpus, shutdown_event, warm_up_size=1000, cache_size=args.cache_size,  log_file="request_throughput_climbing_MoDM.csv"
):
